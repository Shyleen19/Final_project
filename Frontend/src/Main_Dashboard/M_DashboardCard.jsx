...
const M_DashboardCard = ({ totalPatients, totalCaregivers, normal, warning, danger }) => {
  return (
    <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <StatCard title="Critical Patients" value={danger} bgColor="bg-red-200" textColor="text-red-800" />
      <StatCard title="Warning Status" value={warning} bgColor="bg-yellow-200" textColor="text-yellow-800" />
      <StatCard title="Stable Patients" value={normal} bgColor="bg-green-200" textColor="text-green-800" />
      <StatCard title="Total Caregivers" value={totalCaregivers} bgColor="bg-[#88E1FF]" textColor="text-black-100" />
      <StatCard title="Total Registered Patients" value={totalPatients} bgColor="bg-[#88E1FF]" textColor="text-black-100" />
